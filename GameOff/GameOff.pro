...
unrealRootPath=/home/ilya/UnrealEngine
GameOffRootPath=/home/ilya/UnrealProjects/GameOff/GameOff

gameProjectFile=/home/ilya/UnrealProjects/GameOff/GameOff/GameOff.uproject
...
include(GameOffSource.pri)
include(GameOffHeader.pri)
include(GameOffConfig.pri)
include(GameOffIncludes.pri)
include(GameOffDefines.pri)
...
GameOff-Linux-Debug.commands = $$build GameOff Linux Debug  -project="\"$$gameProjectFile\"" $$args
GameOff-Linux-DebugGame.commands = $$build GameOff Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
GameOff-Linux-Shipping.commands = $$build GameOff Linux Shipping  -project="\"$$gameProjectFile\"" $$args
GameOff-Linux-Test.commands = $$build GameOff Linux Test  -project="\"$$gameProjectFile\"" $$args
GameOff.commands = $$build GameOff Linux Development  -project="\"$$gameProjectFile\"" $$args

GameOffEditor-Linux-Debug.commands = $$build GameOffEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
GameOffEditor-Linux-DebugGame.commands = $$build GameOffEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
GameOffEditor-Linux-Shipping.commands = $$build GameOffEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
GameOffEditor-Linux-Test.commands = $$build GameOffEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
GameOffEditor.commands = $$build GameOffEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	UE4Server \
	GameOff-Linux-Debug \
	GameOff-Linux-DebugGame \
	GameOff-Linux-Shipping \
	GameOff-Linux-Test \
	GameOff \
	GameOffEditor-Linux-Debug \
	GameOffEditor-Linux-DebugGame \
	GameOffEditor-Linux-Shipping \
	GameOffEditor-Linux-Test \
	GameOffEditor \
